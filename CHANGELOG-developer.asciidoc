...
=== Beats version 7.1.1
https://github.com/aliksend/beats/compare/v7.1.0..v7.1.1[Check the HEAD diff]

=== Beats version 7.1.0
https://github.com/aliksend/beats/compare/v7.0.0..v7.1.0[Check the HEAD diff]

=== Beats version 7.0.1
https://github.com/aliksend/beats/compare/v7.0.0..v7.0.1[Check the HEAD diff]

=== Beats version 7.0.0-GA
https://github.com/aliksend/beats/compare/v7.0.0-rc2..v7.0.0[Check the HEAD diff]
...
https://github.com/aliksend/beats/compare/v6.3.0..v7.0.0-alpha2[Check the HEAD diff]
...
- Dashboards under _meta/kibana are expected to be decoded. See https://github.com/aliksend/beats/pull/7224 for a conversion script. {pull}7265[7265]
- Constructor `(github.com/aliksend/beats/libbeat/output/codec/json).New` expects a new `escapeHTML` parameter. {pull}7445[7445]
