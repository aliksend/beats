...
class Test(BaseTest):
    ...
    @unittest.skip('flaky test https://github.com/aliksend/beats/issues/12037')
    ...
    @unittest.skipIf(os.name == 'nt', 'flaky test https://github.com/aliksend/beats/issues/9214')
