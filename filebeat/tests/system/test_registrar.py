...
class Test(BaseTest):
    ...
    @unittest.skipIf(os.name == 'nt' or platform.system() == "Darwin", 'flaky test https://github.com/aliksend/beats/issues/8102')
    ...
    @unittest.skipIf(os.name == 'nt', 'flaky test https://github.com/aliksend/beats/issues/7690')
    ...
    @unittest.skip('flaky test https://github.com/aliksend/beats/issues/10606')
