...
```
python ${GOPATH}/src/github.com/aliksend/beats/packetbeat/scripts/create_tcp_protocol.py
```
...
```
  $ cd ${GOPATH}/src/github.com/aliksend/beats/packetbeat
  $ python ${GOPATH}/src/github.com/aliksend/beats/packetbeat/scripts/create_tcp_protocol.py
```

Load plugin into packetbeat by running `make update`. Or add `_
"github.com/aliksend/beats/packetbeat/protos/echo"` to the import list in
`$GOPATH/src/github.com/aliksend/beats/packetbeat/include/list.go`.
...
`$GOPATH/src/github.com/aliksend/beats/packetbeat/protos` and importing module in
`$GOPATH/src/github.com/aliksend/beats/packetbeat/include/list.go`.
...
import (
	...
	"github.com/aliksend/beats/packetbeat/beater"
