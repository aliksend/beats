...
https://github.com/aliksend/beats/tree/master/testing/environments[beats/testing/environments] to import, create, and
...
https://github.com/aliksend/beats/tree/master/dev-tools/cmd/dashboards[dev-tools] for exporting Kibana 6.0 dashboards or later, and the Python script `export_5x_dashboards.py`
for exporting Kibana 5.x dashboards. See the dev-tools
https://github.com/aliksend/beats/tree/master/dev-tools/README.md[readme] for more info.
