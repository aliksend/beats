...
https://github.com/aliksend/beats/blob/master/metricbeat/scripts/module/metricset/metricset.go.tmpl
...
https://godoc.org/github.com/aliksend/beats/libbeat/common#MapStr[MapStr API docs].
...
https://godoc.org/github.com/aliksend/beats/libbeat/common/schema[schema] package
