...
$ git clone https://github.com/aliksend/beats.git
----------------------------------------------------------------------
...
* In the `$GOPATH/src/github.com/aliksend/beats` folder, add your fork
...
https://github.com/aliksend/beats/tree/master/packetbeat/scripts/tcp-protocol.
