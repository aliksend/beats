...
----
cd $\{GOPATH\}/src/github.com/aliksend/beats
git checkout {branch}
----
...
----------------------------------------------------------------------
{
  ...
  "path": "./vendor/github.com/aliksend/beats/winlogbeat/winlogbeat.yml",
  "type": "lsbeat"
}

{
  ...
  "filesize": 238,
  "modtime": "2016-07-13T20:56:21.000Z",
  "path": "./vendor/github.com/aliksend/beats/winlogbeat/tests/system",
  "type": "lsbeat"
}
----------------------------------------------------------------------
...
[source,shell]
--------------------
python $GOPATH/src/github.com/aliksend/beats/script/generate.py
--------------------
